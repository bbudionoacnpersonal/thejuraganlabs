          ...
          <div className="flex flex-wrap items-end gap-4">
            ...
            <div className="relative flex-grow min-w-[250px]">
              ...
              <input
                ...
                className="w-full h-[50%] bg-dark-surface border border-dark-border rounded-md py-2 pl-12 pr-4 text-white text-sm placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-secondary-600"
              />
            </div>
