import { Node, Edge, MarkerType, Position } from 'reactflow'; import { getAutoLayout } from '../../../utils/dagreLayout';
...
// 🎯 CRITICAL FIX: Always create edges if nodes exist, regardless of conversation state
...
// Edge 2: Team → Agents (🎯 CRITICAL FIX: Always create if both nodes exist)
